...
/**
 * Interface for a directional graph.
 *
 * @param <E> Type of the underlying data representing an edge
 * @param <N> Type of the underlying data representing a node
 */
public interface Digraph<E, N> {
